...
▢ *TOP ${len} XP* 🧬
SEN : *${usersExp.indexOf(m.sender) + 1}* de *${usersExp.length}*
...
▢ *TOP ${len} DIAMONDS💎* 
SEN : *${usersLim.indexOf(m.sender) + 1}* de *${usersLim.length}*
...
▢ *TOP ${len} LEVEL* ⬆️
SEN : *${usersLevel.indexOf(m.sender) + 1}* de *${usersLevel.length}*
